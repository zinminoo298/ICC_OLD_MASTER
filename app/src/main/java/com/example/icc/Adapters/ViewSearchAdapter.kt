...
class ViewSearchAdapter(
    private var Dataset: ArrayList<ViewSearchModel>,
    private val context: Context
) :
    RecyclerView.Adapter<ViewSearchAdapter.MyViewHolder>() {

    class MyViewHolder(val view: View) : RecyclerView.ViewHolder(view) {
        val txtBarcode = itemView.findViewById<TextView>(R.id.txtview_location)
