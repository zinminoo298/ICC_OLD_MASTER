...
class ViewSearch : AppCompatActivity() {
    companion object{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textViewS.text = ViewShelfAdapter.s
        ...
        viewAdapter = ViewSearchAdapter(DatabaseHandler.ViewSearch, this)
        ...
        var list = DatabaseHandler.ViewSearch
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(newText: String): Boolean {
                // search goes here !!
                var filteredList = ArrayList<ViewSearchModel>()
                if (newText != "") {
                    for (item in list) {
    ...
    private fun setupRecyclerView(list: ArrayList<ViewSearchModel>) {
        viewAdapter = ViewSearchAdapter(list, this)
